#!/usr/bin/env python3
"""
Train ePINN-AF on the forward KdV equation and save results.

Usage:
    python train.py --data /path/to/KdV.mat
    python train.py --data /path/to/KdV.mat --n-iter 10000
"""
import argparse
import pickle
import time
...
def main():
    ...
    ap.add_argument('--out', default='kdv_epinn_af_results.pkl')
    args = ap.parse_args()
