"""
ePINN-AF training wrapper for the (forward) Allen-Cahn equation.
...
class PhysicsInformedNN:
    """ePINN-AF training wrapper for the Allen-Cahn equation."""
    ...
    def net_f(self, x, t):
        """Allen-Cahn residual: u_t - 0.0001*u_xx + 5*u^3 - 5*u = 0"""
        u = self.net_u(x, t)
